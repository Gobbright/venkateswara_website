...
import DbProductCollection from '../products/DbProductCollection';
...
export const routes = [
  ...
  { path: '/mens', element: <DbProductCollection title="Mens Collection" category="Mens" />, name: 'Mens' },
  { path: '/accessories', element: <DbProductCollection title="Accessories" category="Accessories" />, name: 'Accessories' },
  { path: '/womens', element: <DbProductCollection title="Womens Collection" category="Womens" />, name: 'Womens' },
  { path: '/kids', element: <DbProductCollection title="Kids Collection" category="Kids" />, name: 'Kids' },
  { path: '/categories', element: <CategoriesPage />, name: 'All Categories' },
  { path: '/festive-wear', element: <DbProductCollection title="Festive Wear" category="Festive" />, name: 'Festive Wear' },
